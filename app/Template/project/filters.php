<div class="page-header">
    ...
    <!-- Yahan se "Actions" drop down menu ko Mitana he -->
    
    <!-- /yahan tak is ko mitana he -->
    ...
    <div class="filter-dropdowns">
        ...
        <!-- REMOVING USERS BUTTON -->
        <?php // if (isset($users_list)): ?>
        <!--
            <div class="dropdown filters">
            <i class="fa fa-caret-down"></i> <a href="#" class="dropdown-menu"><?php // <?= t('Users') ?></a>
            <ul>
                <li><a href="#" class="filter-helper" data-append-filter="assignee:nobody"><?php //<?= t('Not assigned') ?></a></li>
                <?php // foreach ($users_list as $user): ?>
                    <li><a href="#" class="filter-helper" data-append-filter='assignee:"<?php //<?= $this->e($user) ?>"'><?php //<?= $this->e($user) ?></a></li>
                <?php // endforeach ?>
            </ul>
            </div>
        -->
        <?php // endif ?>
        <!-- / REMOVING USERS BUTTON ENDS HERE -->
        <!-- SETTINGS BUTTON -->
        ...
        <!--
        <div class="dropdown filters">
        <i class="fa fa-caret-down"></i> <a href="#" class="dropdown-menu"><?php //<?= t('View') ?></a>
        <ul>
            <?php // if (isset($is_board)): ?>
            <li>
                <span class="filter-display-mode" <?php //<?= $this->board->isCollapsed($project['id']) ? '' : 'style="display: none;"' ?>>
                    <i class="fa fa-expand fa-fw"></i>
                    <?php //<?= $this->url->link(t('Expand tasks'), 'board', 'expand', array('project_id' => $project['id']), false, 'board-display-mode', t('Keyboard shortcut: "%s"', 's')) ?>
                </span>
                <span class="filter-display-mode" <?php //<?= $this->board->isCollapsed($project['id']) ? 'style="display: none;"' : '' ?>>
                    <i class="fa fa-compress fa-fw"></i>
                    <?php //<?= $this->url->link(t('Collapse tasks'), 'board', 'collapse', array('project_id' => $project['id']), false, 'board-display-mode', t('Keyboard shortcut: "%s"', 's')) ?>
                </span>
            </li>
            <li>
                <span class="filter-compact">
                    <i class="fa fa-th fa-fw"></i> <a href="#" class="filter-toggle-scrolling" title="<?php //<?= t('Keyboard shortcut: "%s"', 'c') ?>"><?php //<?= t('Compact view') ?></a>
                </span>
                <span class="filter-wide" style="display: none">
                    <i class="fa fa-arrows-h fa-fw"></i> <a href="#" class="filter-toggle-scrolling" title="<?php //<?= t('Keyboard shortcut: "%s"', 'c') ?>"><?php //<?= t('Horizontal scrolling') ?></a>
                </span>
            </li>
            <li>
                <span class="filter-max-height" style="display: none">
                    <i class="fa fa-arrows-v fa-fw"></i> <a href="#" class="filter-toggle-height"><?php //<?= t('Set maximum column height') ?></a>
                </span>
                <span class="filter-min-height">
                    <i class="fa fa-arrows-v fa-fw"></i> <a href="#" class="filter-toggle-height"><?php //<?= t('Remove maximum column height') ?></a>
                </span>
            </li>
            <?php // endif ?>
    ...
    -->
        ...
        <?php // if (isset($categories_list) && ! empty($categories_list)): ?>
            <!--
            <div class="dropdown filters">
            <i class="fa fa-caret-down"></i> <a href="#" class="dropdown-menu"><?php // <?= t('Categories') ?></a>
            <ul>
                <li><a href="#" class="filter-helper" data-append-filter="category:none"><?php // <?= t('No category') ?></a></li>
                <?php // foreach ($categories_list as $category): ?>
                    <li><a href="#" class="filter-helper" data-append-filter='category:"<?php // <?= $this->e($category) ?>"'><?php // <?= $this->e($category) ?></a></li>
                <?php // endforeach ?>
            </ul>
            </div>
            --> 
